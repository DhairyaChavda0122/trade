  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row">
          <div className="col-3">
            <p className="ms-2">TRADE AFTER</p>
            <a
              href="/"
          ...
          <div className="col-3">
            <p className="ms-2">TRADE BEFORE</p>
            <a
              href="/"
              className="nav-link border text- my-2 py-3  navbar-border-radius bg-orange color-white "
              aria-current="page"
          ...
          <div className="col-2">
            <p className="ms-2">SELECT MARKET</p>
          ...
          <div className="col-2">
            <p className="ms-2">SELECT SCRIPT</p>
            <div className="btn-group w-100 height-button bg-orange">
              <button type="button" className="btn color-white focus-none">
                Select...
              </button>
