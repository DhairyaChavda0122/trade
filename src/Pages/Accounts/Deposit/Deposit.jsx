    ...
    <>
      <Fade right bottom>
        ...
        <div className="container">
          ...
          {/* cash code */}
          <div className="row align-items-center my-3">
            <div className="col-3">Deposit Code</div>
            <div className="col-5">
              <select
                className="form-select input-border focus-none"
                id="inputGroupSelect01"
              >
                <option className="">DEPOSIT</option>
                <option value="1">DIPOADANI</option>
                <option value="1">LPL</option>
                <option value="1">TARAD</option>
              </select>
            </div>
            <div className="col-3">
              <span>Balance : 1,085,857,400.00 (Cr)</span>
            </div>
